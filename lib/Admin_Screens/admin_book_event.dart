...
class admin_book_event extends StatefulWidget {
  const admin_book_event({Key? key}) : super(key: key);

  @override
  State<admin_book_event> createState() => _admin_book_eventState();
}

class _admin_book_eventState extends State<admin_book_event> {
  ...
  Future foodBooking() async{
    final uri = Uri.parse("http://$IP_Address/Charity_Hope/admin_event_registration.php");
