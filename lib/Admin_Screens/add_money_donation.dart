...
class add_money_donation extends StatefulWidget {
  const add_money_donation({Key? key}) : super(key: key);

  @override
  State<add_money_donation> createState() => _add_money_donationState();
}

class _add_money_donationState extends State<add_money_donation> {
                  ...
                  child: ElevatedButton(
                    onPressed: () async {
                      if (formKey.currentState!.validate()) {
                        addDonation();
                        Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => view_money_donation()),);
                      }
                    },
  ...
  Future addDonation() async{
    ...
    final uri = Uri.parse("http://$IP_Address/Charity_Hope/addmin_add_donation.php");
